...
func Routers() *gin.Engine {
	...
	Router.StaticFS(global.GvaConfig.Local.StorePath, http.Dir(global.GvaConfig.Local.StorePath)) // 为用户头像和文件提供静态地址
